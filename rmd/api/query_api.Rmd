...
This document was created to instruct how to use the statistical programming language, R, to query the Water Quality Modernization and Assessments (WQMA) representational state transfer (REST) application programming interface (API). WQMA represents an Oracle database comprised of data stored as JavaScript Object Notation (JSON) format.
